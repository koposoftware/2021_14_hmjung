				...
				<div class="col-12">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">광고주 인증 요청 목록</h4>
								...
								<table class="table table-bordered no-margin">
								  ...
								  <tbody>
								   <c:forEach items="${ list }" var="request" varStatus="loop">
									<tr>
									  <td>
										<a href="${ pageContext.request.contextPath }/account/advertise/valid/each/${request.no }" class="hover-primary">
										  ${request.no }
										</a>
									  </td>
									  <td>${request.id }</td>
									  ...
									  <c:if test="${request.status eq  'WAIT'}">
									  	...
									  	<span style="float:right"><a href="${ pageContext.request.contextPath }/account/advertise/valid/each/${request.no }"> 조회<i class="mdi mdi-arrow-right"></i> </a> </span>
									  	</td>									  	
									  </c:if>
