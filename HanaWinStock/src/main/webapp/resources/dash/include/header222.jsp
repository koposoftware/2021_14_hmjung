...
<nav class="nav-white bg-white">
	...
	<div class="nav-header" style="max-height:62px;">
		<a type="button" class="w3-button w3-teal w3-xlarge" onclick="w3_open()">☰</a>
	 
		<a href="${ pageContext.request.contextPath }/" style="margin-top:0px; padding-top:0px; padding-bottom:20px;" class="brand"> 
